 ...
 */
@BotCommand
@CommandPkg(label="Blur", name="blur", description="Blur an image", icon="pkg.svg",
		node_label="Blur Image {{imagePath}}",
...
public class Blur {
	...
	public Value<String> action(
		...
		try{
			fb.toGrayscale();
			Catalano.Imaging.Concurrent.Filters.Blur d = new Catalano.Imaging.Concurrent.Filters.Blur();
			d.applyInPlace(fb);
