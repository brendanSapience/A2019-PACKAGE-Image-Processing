...
public final class DesaturateCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DesaturateCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    if(parameters.get("factor") == null || parameters.get("factor").get() == null) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.notEmpty","factor"));
    }
    ...
    if(parameters.get("factor") != null && parameters.get("factor").get() != null && !(parameters.get("factor").get() instanceof Double)) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","factor", "Double", parameters.get("factor").get().getClass().getSimpleName()));
    }
